...
app.config['hostname'] = '2f3279a5-73d1-4859-88f0-a6c3e6b4b907.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud'
app.config['port'] = '30756'
app.config['protocol'] = 'tcpip'
app.config['uid'] = 'jgv11848'
app.config['pwd'] = 'tf4g7EltzuerAS7Z'
